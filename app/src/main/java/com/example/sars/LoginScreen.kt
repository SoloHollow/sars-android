                    ...
                    OutlinedTextField(
                        ...
                        trailingIcon = {
                            val image = if (showPassword)
                                painterResource(id = R.drawable.ic_launcher_foreground) // Replace with visibility on icon
                            else
                                painterResource(id = R.drawable.ic_launcher_foreground) // Replace with visibility off icon
